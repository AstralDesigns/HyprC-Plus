...
var DockConfig = {
    ...
    // candy-utils sed pattern:  sed -i "s/startIcon: '󰚾',
    startIcon: '󰚾',              // @HCD:startIcon
    ...
    indicatorSize: null,
    indicatorSizeFraction: 1.0,  // used when indicatorSize is null
    ...
    borderColorVar: 'primary_container', // @HCD:borderColorVar  (GTK @name, matugen)
    ...
    exclusiveZoneOverride: 0,      // 'null' for windows to respect dock's exclusive zone or '0' to ignore. 
