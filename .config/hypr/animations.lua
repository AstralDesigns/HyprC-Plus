-- HyprCandyPlus selected animation preset.
-- Generated from ~/.config/hypr/conf/animations/ja.conf by animations.sh.
-- This file is loaded by hyprland.lua after hyprviz.lua.
