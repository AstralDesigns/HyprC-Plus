...
// ═══════════════════════════════════════════════════════════════════════════
//  CCTheme.qml — Live matugen M3 color bridge for the control center
//  Mirrors bar/Theme.qml but independent so the CC can run as its own
//  Quickshell config without depending on bar internals.
// ═══════════════════════════════════════════════════════════════════════════
