...
class CavaServer:
    ...
    def __init__(self):
        ...
        self.socket_file = os.path.join(self.runtime_dir, "hyprcandy-lock", "cava.sock")
        self.pid_file = os.path.join(self.runtime_dir, "hyprcandy-lock", "cava.pid")
        self.temp_dir = Path(os.path.join(self.runtime_dir, "hyprcandy-lock"))
